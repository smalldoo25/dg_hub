...
export const productsAnalyticsAI = {
    ...
    <section data-group-id="group-productanalyticsai-introduction">
            <h1 align=center>Product Analytics and AI</h1>
                ...
                a clear sense of what they value, and the ability to measure, learn, and
                improve at speed. Product analytics and AI bring all these elements together,
                giving product managers the tools to make smarter decisions and deliver
                outcomes that truly matter.</p>

                <p>At
                the heart of this approach is <b>Customer Analytics</b> which uses real data to
                understand who your customers are, what jobs they’re trying to get done, and
                how they interact with your product. It’s about turning raw information into
                insights that guide design, prioritisation, and investment decisions, ensuring
                every feature has a clear reason to exist.</p>

                <p>Layered
                on top is <b>Data Science for Product Managers</b>, which transforms those
                insights into action. Predictive AI helps forecast behaviour and spot potential
                issues before they escalate, while generative AI accelerates experimentation by
                creating and testing new concepts at scale. When combined, these capabilities
                allow teams to move faster, personalise experiences, and continuously optimise
                for user outcomes.</p>

                <p>But
                knowing what to build is only part of the equation. <b>Usability Analytics</b>
                ensures that the solutions we create are easy, intuitive, and enjoyable to use.
                By embedding tracking from design through to delivery, and by combining
                behavioural metrics with qualitative feedback, teams can identify friction
                points early, adapt quickly, and make usability a proactive part of the product
                lifecycle.</p>

                <p>Finally,
                <b>Demand and Value Analytics</b> confirm whether our solutions are truly
                wanted and worth paying for before heavy investment. Lean, rapid experiments
                such as landing page tests, pre-orders, and fake features validate demand and
                shape the value proposition, making sure we’re solving the right problems for
                the right audience.</p>

                <p>Together,
                these four disciplines create a product management toolkit powered by evidence
                and enhanced by AI. It’s a cycle of asking better questions, testing smarter,
                and learning faster, so every decision moves you closer to delivering products
...
<section data-group-id="group-productanalyticsai-consumer-analytics">  
    ...
    <h2 id="productanalyticsai-consumer-analytics-customer-introduction" align=center>Introduction to Customer
        ...
        <p>What do we mean by Product Analytics?  Well, the best way to
            ...
            it is important to understand the true meaning of words that are often used
            interchangeably.   Let us start with our understanding of data.  What is data?
            findings? Insights? and metrics?</p>
        ...
        <ul>
            ...
            <li>Website analytics numbers (pageviews, clicks, etc.)</li>
        ...
        <p>Metrics are specific data points that are measured and
            ...
            performance. In other words, it is a numerical measurement of something.  That
            thing might be performance, goals, KPIs, or value.        </p>
        ...
        <ul>
            <li>Users struggled with the checkout flow due to unclear pricing
                information, resulting in high cart abandonment. Simplifying pricing could
                increase conversions.</li>

            <li>The recent homepage redesign caused a spike in bounce rate
                because the new layout lacked clear navigation cues. Improving information
                architecture is needed.</li>
        </ul>

        <p>In summary, data is the raw input, findings are observations
            from analysing the data, metrics quantify performance, and insights are the
            synthesised recommendations that drive actions.</p>

        <p>&nbsp;</p>

        <p><span style='color:black'>Analytics is the discipline of
                uncovering meaningful patterns in data to drive informed decision-making. In
                today’s outcome-focused environment, where OKRs defines value by conducting
                research and analysing data to gain deeper insights into customers, products,
                and team performance has become essential. These insights empower organisations
                to continuously improve and deliver greater value.<br>
                <br>
            </span></p>
    ...
    <section data-subitem-id="productanalyticsai-consumer-analytics-hypothesis-driven-development-revisited">
        ...
        <p><span style='color:black'>At DeftAgile, we approach Agile
            ...
            your decisions in analytics and structured experiments, your product becomes
            the result of validated insights, not guesswork. In a nutshell, HDD isn't just
            a framework, it’s a mindset. We treat product development as a pipeline of
            testable intentions, and not just tasks to complete. It is all about
            outcome-first, and evidence-led.</p>

        <p style='margin-left:36.0pt'><b><span style='color:black'>Start
                    with demand, not code</span></b><span style='color:black'> We define durable
                user jobs and identify underserved needs. If alternatives fall short, our
                proposition should resonate by testing with lightweight MVPs.</span></p>

        <p style='margin-left:36.0pt'><b><span style='color:black'>Design
                    iteratively, test purposefully</span></b><span style='color:black'> Begin with
                continuous discovery by establishing who is the persona? what’s their
                job-to-be-done? and how do we validate demand before diving into usability and
                interface?</span></p>

        <p style='margin-left:36.0pt'><b><span style='color:black'>Increase
                    specificity, reduce waste</span></b><span style='color:black'> Each stage
                narrows options and raises investment. We prioritise lean experiments: fewer
                guesses, more about validated learning.</span></p>

        <p style='margin-left:36.0pt'><b><span style='color:black'>Build
                    with intent, not inertia</span></b><span style='color:black'> Every feature,
                practice, or deployment is a hypothesis. We make our reasoning explicit,
                measure impact, and iterate accordingly.</span></p>
        ...
        <p><b><span style='color:black'>Types of Data</span></b></p>

        <ul>
            <li><b>Hypothesis validation data:</b>
                User interactions, feature utilisation metrics.</li>
            <li><b>Cohort Data:</b> Segmented user
                behaviour insights.</li>
        </ul>

        <p><b><span style='color:black'>Key Metrics</span></b></p>

        <ul>
            <li><b>Hypothesis Validation Rate:</b>
                Track percentage of successfully validated hypotheses.</li>
            <li><b>User Retention Rate:</b> Measure
                user loyalty post-validation.</li>
        </ul>

        <p><b><span style='color:black'>AI Applications</span></b></p>

        <ul>
            <li><b>Cohort Analysis Automation:</b> AI
                segments users based on interaction patterns, rapidly testing multiple
                hypotheses simultaneously.</li>
            <li><b>Natural Language Processing (NLP):</b>
                Analyses user feedback, quickly validating assumptions against actual user
                sentiment.</li>
        </ul>

        <p><span style='color:black'>&nbsp;</span></p>

        <p align=center><b>Hypothesis Driven
                Development Process</b></p>

        <p><span style='color:black'>These days, the word pivot has new
                meaning.  Development and Discovery teams must learn to evolve continuously and
        ...
        <p><span style='color:black'>An evolutionary approach begs us
                ...
                What are the main differences between them?</span></p>
        ...
        <p style='margin-left:144.0pt;text-indent:36.0pt'><span style='color:black'>(Source Adrian Cho. 
                IBM: </span><a
                href="https://www.ibm.com/garage/method/practices/learn/practice_hypothesis_driven_development/">Hypothesis
                Driven Development</a><span style='color:black'>)</span></p>

        <p><span style='color:black'>&nbsp;</span></p>

        <p><span style='color:black'>If a hypothesis is false, you can pivot
                and create another set of hypotheses. Researchers have to come to terms that
                our world is constantly changing, and decisions based on assumption is the
                death of any company, data-based decisions based on customer needs is the way
        ...
        <table class='table'>
            ...
            <tr>
                <td>
                    ...
                    <p>Relevant keywords in ads</p>
                </td>
                <td>
                    <p>Relevant keywords in Landing pages</p>
        ...
        <p><span style='color:black'>The proving or disproving a
                ...
                if hypothesis can’t be proven, the outcome might provide valuable insights that
                we can use in another hypothesis.<br>
            </span><b><span style='font-size:12.0pt;line-height:107%;color:black'>                
                </span></b></p>

        <p><span style='color:black'>Adopt a mindset of continuous
                discovery and implementation, where you can explore multiple options. A/B Split
                testing Where you can send traffic to (A) current feature and the other traffic
                to (B) The new feature</span></p>

        <p><span style='color:black'>Multivariate testing is also
        ...
        <p><span style='color:black'>How do we keep track of and
                analyse all of these efforts? The outcome of any HDD iteration is the value it
                was aiming to deliver.  How do we measure this value? data is needed to
                validate any hypothesis and teams’ success depends on this.  Quantifying what
                worked and what didn’t is also important feedback for all concerned. </span></p>

        <p><b><span style='color:black'>&nbsp;</span></b></p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="650" height="350"
                src="./images/productsanalyticsai/consumeranalytics/image001.png"></p>

        <p>(<b>Source</b>: Alex Cowan, adapted from the UK Design
            Council and ‘The design of everyday things’)</p>
        ...
        <p><span style='color:black'>What is a Persona?</span><span style='color:black'><br>
                ...
                “Personas are fictional characters, which you create based upon your
                    ...
                    personas can help you step out of yourself. It can help you recognise that
                    different people have different needs and expectations, and it can also help
        ...
        <p><span style='color:black'>(<b>Source</b>: Dam, R. F. and
                ...
                Design Foundation IxDF. </span><a
                href="https://www.interaction-design.org/literature/article/personas-why-and-how-you-should-use-them">Personas:
                why/and how to use them</a><span style='color:black'>)<br>
                <br>
            </span></p>
...
color:black'>&nbsp;</span></b></p>
        ...
        <p><span style='color:black'>A persona hypothesis is an assumption
                ...
                group. In this context, personas are fictional representations of specific user
                segments based on research and data. A persona hypothesis is a preliminary idea
                of who our users are, what they need, their likes and dislikes etc</span></p>

        <p><span style='color:black'>Creating a persona hypothesis begins
                at the early stages of the product development process. It consists of gathering
                information through user research, surveys, interviews, and other methods to
                form an initial understanding of our target audience. The persona hypothesis
                research, is the genesis of our quest to be customer centric. Further research
                and development activities lays out the foundation of designing solutions that
                are more likely to meet the needs of the intended users.</span></p>

        <p><span style='color:black'>Once the initial hypothesis is
...
color:black'>(b) Problem/JTBD hypothesis (Can we solve their
        ...
        <p><b> A problem hypothesis</b> is an assumption that expressed
            ...
            hypothesis is to define and frame a problem in a way that can be tested and
            validated through research and experimentation.</p>

        <p>The hypothesis might articulate who is affected by the
            problem, what the problem is, and why it's important to address.</p>
        ...
        <p>Once a problem hypothesis is formulated, the next steps
            ...
            validate or refine it. This process ensures that the team's efforts are
            directed toward solving a real and significant problem that users actually
            face.</p>

        <p><b>A &quot;Jobs to be Done&quot;</b> (JTBD) hypothesis is a
            statement that expresses an assumption about the functional and emotional
            progress a person is trying to achieve when using a product or service. The
            Jobs to be Done framework is a concept in product and service design that
            focuses on understanding the underlying motivations and goals of users.  JTBD
            considers the &quot;job&quot; or task that a user is hiring a product or
            service to accomplish.</p>
...
11.0pt;font-family:"Inter",sans-serif'>3.<span>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <ul>
            <li>Iteratively
                validate or invalidate your hypotheses using consumer data, analytics, and
...
11.0pt;font-family:"Inter",sans-serif'>4.<span>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <ul>
            <li>Encourage
                decision-making grounded in empirical evidence rather than guesswork or
                assumptions.</li>
...
<section data-subitem-id="productanalyticsai-consumer-analytics-iteration-with-purpose">
        ...
        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="650" height="300"
                src="./images/productsanalyticsai/consumeranalytics/image003.png"></p>

        <p align=right style='text-align:right'><b><span style='font-size:10.0pt;line-height:107%;color:black'>Source:
                    Alex Cowan.  Product
                    Pipeline alexcowan.com</span></b></p>

        <p><span style='color:black'>As product managers, we often find
                ourselves iterating because Agile demands it. But intentional iteration is
                ...
                decisions based on insights from inception to completion.  Some might say that
                is norm but you would be surprised how many product managers and owners base
                decision on assumptions or ideas without testing them. This is where the
                scientific approach comes in.  Qualitative data during the brainstorming phase will
                help to make sense of what is tangible and what’s not.  This is about driving
                value from inception all the way to completion using well informed insights in
                your feedback loops, resulting in making better decisions. Imagine your team
                building fewer features better and with more focus!  Imagine having a backlog
                not cluttered with PBIs that makes no sense to either the team or product manager! 
                This is all about experimenting before validating what works and not the other
                way round</span></p>
        ...
        <ul>
            <li> Making a habit of creating clarity of
                what constitutes as success using analytics and AI<br>
            </li>

            <li> Making meaningful observation from the
                start middle and end of your product pipeline<br>
            </li>

            <li> Taking action based on data insights.
                This enables teams to focus more on outcomes</li>
        </ul>

        <p><span style='color:black'>Google, among others puts
                experimentation first with only 10% success rates, and yet they are very
        ...
        <ul>
            <li>How much does it cost to release a
                successful feature?</li>

            <li>What does it cost to build a feature?</li>

            <li>How many released features are
                successful?</li>
        </ul>
...
<section data-subitem-id="productanalyticsai-consumer-analytics-reclaiming-science-in-product-thinking">
        ...
        <p align=center><b><span style='font-size:14.0pt;line-height:107%;color:black'><img class="img-fluid rounded-corners mt-3"  border=0 width="650" height="300" src="./images/productsanalyticsai/consumeranalytics/image005.png"></span></b></p>

        <p><b><span style='color:black'><br>
                </span></b>Being scientific doesn't mean losing creativity, it’s about
            rigorously testing your creative ideas. Think of yourself as a product scientist,
            each idea is an experiment, each iteration an opportunity to learn. This way,
            analytics and consumer data become tools that not only inform but empower your
...
font-family:"Inter",serif'>  </span>We understand science has a
        ...
        <ul>
            <li><b>Idea → Hypothesis → Decision</b> A hypothesis is simply
                an idea we’re willing to test and risk being wrong about. “If we make the
                landing page blue, then click-through will improve.” That kind of
                precision opens doors to faster, smarter experimentation.</li>
            <li><b>Small data meets big impact</b> We start with
                qualitative observation of jobs-to-be-done, behavioural insights, and
                pattern recognition. This fuels plausible, grounded hypotheses. Science
                doesn’t reject intuition, it sharpens it.</li>
            <li><b>Experiment with intention</b> in digital, we have the
                tools to test rapidly and affordably. But effective experimentation still
                requires thoughtful design, clear metrics, and decisions pre-baked into
                the process: If this, then that.</li>
            <li><b>Learn, decide, move forward</b> Every experiment should
                influence a business decision. Whether a result is true or false, it must
                guide action. Otherwise, it’s just noise.</li>
            <li><b>Empowered by analytics and AI</b> We’ll layer nuanced
                decision frameworks onto scientific practice hence bridging rigour with
                responsiveness. This is how we reduce waste and multiply learning velocity</li>
        </ul>
...
<section data-subitem-id="productanalyticsai-consumer-analytics-direct-customer-insight">
        ...
        <p>It's easy to get comfortable behind our screens, but truly
            impactful product decisions happen when you engage directly with your
            customers, see the world from their perspective, and you'll find analytics
            become richer and more insightful. </p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
                src="./images/productsanalyticsai/consumeranalytics/image006.jpg" alt="Generated image"></p>

        <p>Imagine Terry the Technocrat managing an e-commerce site
            selling home electronics. Rather than assuming how customers select products,
            Trent schedules interview and observes shoppers navigating product pages, using
            search filters, and interacting with product recommendations. He discovers that
            customers struggle to find compatible accessories, prompting a hypothesis:
            &quot;If we clearly present accessory compatibility on product pages, we’ll
            improve conversion rates.&quot; Trent then tests this hypothesis through direct
            experiments and analytics</p>
...
<section data-subitem-id="productanalyticsai-consumer-analytics-making-journeys-testable">
        ...
        <p>Customer journeys aren't static diagrams; they're maps of
            human behaviour that show you exactly where your product succeeds or stumbles.
            Make your journey maps detailed enough to test clearly, and you'll quickly
            discover exactly where to focus your experiments. Terry’s experience shows us
            that even small tweaks at critical touchpoints can significantly boost
            outcomes.<br>
            <br>
        </p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300" id="Picture 7"
                src="./images/productsanalyticsai/consumeranalytics/image007.png"
...
"Inter",sans-serif'>: Implement targeted tests (e.g., A/B testing) at
        ...
        <p><span>Imagine
                ...
                You implement a simple experiment making sizing guides interactive—and
                analytics confirm reduced bounce rates and increased conversions.</span></p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300"
                src="./images/productsanalyticsai/consumeranalytics/image008.png"
                alt="Turn this into a journey map image:"></p>
        ...
        <table class='table'>
            ...
            <tbody>
                <tr>
                    <td>Identify Drop-off</td>
                    <td>High
                        bounce rate on product pages</td>
                    <td>Conversion
                        loss</td>
                </tr>
                <tr>
        ...
        <table class='table'>
            <thead class='table-light'>
                <tr>
                    <td>Activities</td>
                    <td>Discover Product</td>
                    <td>Understand Product</td>
                    <td>Select Preferences</td>
                    <td>Checkout </td>
                    <td>Feedback</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>Product Detail Page Views</td>
                    <td>Add-to-Wishlist Rate</td>
                ...
                <tr>
                    ...
                    <td>Bounce Rate</td>
                    <td>Time on Page</td>
                    <td>Conversion Funnel Drop-off</td>
                    <td>Checkout Completion Rate</td>
                    <td>Return Rate</td>
                </tr>
                <tr>
                    <td></td>
                    <td>Search Refinement Rate</td>
...
<section data-subitem-id="productanalyticsai-consumer-analytics-build-your-analytics-portfolio">
        ...
        <p>Your analytics portfolio is not just a dashboard; it is a
            strategic toolkit tailored specifically to your product goals. By carefully
            choosing and regularly updating your analytics, you are not just measuring
            performance, you are also actively shaping your product’s future. Remember,
            every analytics point should help you make smarter decisions faster. A
            portfolio helps product managers systematically gather insights, validate
            hypotheses, and make data-driven decisions leading to improving business
        ...
        <p align=center><br>
            <br>
            <img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" src="./images/productsanalyticsai/consumeranalytics/image010.png">
        </p>

        <p align=center>&nbsp;</p>

        <p align=center><b><span style='font-size:14.0pt;line-height:107%'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
                        id="Picture 21"
                        src="./images/productsanalyticsai/consumeranalytics/image011.png"></span></b><br>
            <br>
        </p>
...
11.0pt;font-family:"Inter",sans-serif'>4.<span>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <ul type=disc>
            <li><b>Independent Variable (IV):</b>
                The input or factor you manipulate to observe impact (e.g. price, email
                timing, UI layout).</li>
            <li><b>Dependent Variable (DV):</b>
                The output or metric affected by changes in the IV (e.g. conversion rate,
                average basket size).</li>
            <li><b>Causality:</b> The
                relationship where changes in IV directly lead to changes in DV, ideally
                shown through controlled experiments.</li>
        </ul>

        <p>Data alone doesn't give answer but structured experiments
            and clear thinking does. Understanding how independent variables influence
            dependent variables transforms analytics from descriptive data into strategic
            decisions. By rigorously testing cause and effect, your product choices are not
            just informed but impactful. In other words, creating actionable inferences
            using dependent variables (DVs), independent variables (IVs), and understanding
            causality with clear inferences, will allow teams to move from data collection
            to insightful decision-making, leading to analytics driving meaningful business
            outcomes in your organisation</p>

        <p>&nbsp;</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300" id="Picture 23"
                src="./images/productsanalyticsai/consumeranalytics/image012.png">
        </p>

        <p style='line-height:normal'>Imagine that you are managing an
            online bookstore. Your primary dependent variable is increasing average order
            value (AOV). You hypothesise (IV) that offering bundled book recommendations
            increases AOV. By running an A/B test (one group sees bundled offers; another
            does not), analytics reveal a significant AOV increase for the bundled group,
            confirming causality.  Let us delve into other examples. </p>
        ...
        <table class='table'>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Delivering
                        emails at 7 AM increases CTR by 12% vs 12 PM, suggesting morning users are
                        more engaged.
                    </td>
                </tr>
            </tbody>
        ...
        <table class='table'>
            <thead class='table-light'>
                <tr>
                    <td><b>IV</b></td>
                    <td><b>DV</b></td>
                    <td><b>Causal Inference</b></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>Placement of CTA button</td>
                    <td>Checkout conversion rate</td>
                    <td>CTA above-the-fold drives 8% higher conversions compared
                        to below-the-fold placement.</td>
                </tr>
            </tbody>
        </table>
        </div>
        ...
        <table class='table'>
            ...
            <tbody>
                <tr>
                    ...
                    <td>A 20% discount leads to a 15% increase in cart adds,
                        compared to 10% discount.</td>
                </tr>
            </tbody>
        </table>
        </div>
        ...
        <p style='line-height:normal'><b>5. Search Filter Refinements</b></p>
        ...
        <p style='line-height:normal'><b>Driving Deeper Causality:
                Agile + Experiments</b></p>

        <p style='line-height:normal'>To validate causality beyond
            correlation:</p>

        <ul type=disc>
            <li>Design hypothesis-driven
                experiments (IV manipulation, controlled environment).</li>
            <li>Leverage split testing, holdout
                groups, and post-launch analysis.</li>
            <li>Align measurement frameworks
                with Agile sprint cycles for iterative refinement.</li>
        </ul>

        <p>&nbsp;</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
                src="./images/productsanalyticsai/consumeranalytics/image013.png"
                alt="A diagram encapsulating IV (Independent Variable), DV (Dependent Variable), and causality in e-commerce product management. Include examples like email timing, homepage layout, discount offers, product page visuals, and search filter refinements. Show relationships and actionable insights.">
        </p>
...
"Inter",sans-serif'>4.<span>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>Your historical data holds untapped insights, and
            retrospective experimentation is the key to unlocking them. By adding AI into
            the mix, you are no longer just reviewing past performance, you are now actively
            predicting and shaping future success. It is about using yesterday’s lessons to
            win tomorrow</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 1"
                src="./images/productsanalyticsai/consumeranalytics/image014.png"
                alt="Create an image for an online fashion retailer based on the following scenario: Suppose you manage an online fashion retailer. Your goal is to optimise email marketing performance. By retrospectively analysing past email campaigns using AI-powered tools, you uncover that personalised AI-generated product recommendations significantly outperformed generic ones. Leveraging these insights, you automated personalised recommendations across all future campaigns, improving click-through rates and revenue. The image should visually represent the scenario, incorporating elements like email marketing, AI analytics, and personalised product recommendations. Ensure the design aligns with the retailer's branding requirements.">
        </p>

        <p>&nbsp;</p>

        <p>Suppose you manage an online fashion retailer. Your goal is
            to optimise email marketing performance. By retrospectively analysing past
            email campaigns using AI-powered tools, you uncover that personalised
            AI-generated product recommendations significantly outperformed generic ones.
            Leveraging these insights, you automated personalised recommendations across
            all future campaigns, improving click-through rates and revenue.</p>

        <p><b>Retrospective Case-Control Study</b></p>

        <p><b>Definition:</b> <br>
            A study comparing two group which are, those who experienced an outcome (cases)
            vs those who didn’t (controls) in order to identify factors that might have
            contributed.</p>

        <p><b>E-commerce Example: Cart Abandonment Analysis</b></p>
            ...
            <table class='table'>
                <thead class='table-light'>
                    <tr>
                        ...
                        <td>
                            <p><b>Investigated Factors (IVs)</b></p>
                        </td>
                    </tr>
                </thead>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <p>Users who completed checkout</p>
                    </td>
                    <td>
                        <p>Same factors analysed for comparison</p>
                    </td>
                </tr>
            </table>
            </div>
        ...
        <p><b>SaaS Example: Churn Detection</b></p>
        ...
        <table class='table'>
                ...
                <tr>
                    ...
                    <td>
                        <p>Users retained in Q2</p>
                    </td>
                    <td>
                        <p>Same factors for baseline comparison</p>
                    </td>
                </tr>
            </table>
            </div>
        ...
        <p><b>Retrospective Experiment Pattern</b></p>

        <p><b>Definition:</b> <br>
            Looking back at an uncontrolled product change or rollout, then modelling the
            “experiment” using observed metrics and inferred treatment groups.</p>

        <p><b> E-commerce Example: Pricing Tier Restructure</b></p>

        <p>Let’s say you restructured price tiers last quarter without
            formal A/B testing.</p>
        ...
        <table class='table'>
                <thead class='table-light'>
                    <tr>
                        ...
                        <td>
                            <p><b>Causal Signals</b></p>
                        </td>
                    </tr>
                </thead>
                <tr>
                    <td>
                        <p>New mid-tier price</p>
                    </td>
                    <td>
                        <p>Avg. order value (AOV)</p>
                    </td>
                    <td>
                        <p>Mid-tier users showed 18% higher AOV post-change</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Old pricing group</p>
                    </td>
                    <td>
                        <p>AOV baseline</p>
                    </td>
        ...
        <p><b>SaaS Example: Feature Launch Impact</b></p>
        ...
        <table class='table'>
                <thead class='table-light'>
                    <tr>
                        ...
                        <td>
                            <p><b>Observed Causal Signals</b></p>
                        </td>
                    </tr>
                </thead>
                <tr>
                    <td>
                        <p>Access to new feature</p>
                    </td>
                    <td>
                        <p>Session duration + NPS</p>
                    </td>
                    <td>
                        <p>Engaged users saw 22% longer sessions &amp; +15 NPS</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Non-access users</p>
                    </td>
                    <td>
                        <p>Baseline metrics</p>
                    </td>
                    <td>
                        <p>Used as pseudo-control</p>
                    </td>
                </tr>
            </table>
            </div>
...
font-style:normal'>Great products are not just built on what users do today, they
                    ...
                    with greater clarity. It's not guesswork but foresight, grounded and guided by
                    data.</span></em></p>

        <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 73514417"
                src="./images/productsanalyticsai/consumeranalytics/image015.png"
        ...
        <p><strong><span>Miro</span></strong><span
                ...
                build, which later became core to Miro’s paid team plans.</span></p>

        <p><b>Prospective Cohort Study (Observational)</b></p>

        <p><b>Definition:</b> <br>
            You follow a group (cohort) over time, observing who are exposed to a factor
            (IV) and those who are not. Without the need to manipulating anything. You
            track outcomes (DV) to see if exposure correlates with results.</p>
        ...
        <table class='table'>
            ...
            <tr>
                <td>
                    <p>Users who opt into beta</p>
                </td>
                <td>
                    <p>Early feature access</p>
                </td>
                <td>
                    <p>Retention rate, NPS</p>
                </td>
            </tr>
            <tr>
                <td>
                    <p>Users who don’t opt in</p>
                </td>
                <td>
                    <p>No feature access</p>
                </td>
                <td>
                    <p>Baseline metrics</p>
                </td>
        ...
        <table class='table'>
            ...
            <tr>
                ...
                <td>
                    <p>Tiered onboarding flow</p>
                </td>
                <td>
                    <p>Activation rate, time-to-value</p>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <p><b>Strategic Use in Product Management</b></p>

        <ul>
            <li><b>Cohort studies</b> are great for long-term
                observational insights when randomisation isn’t feasible.</li>
            <li><b>Experimental studies</b> are ideal for validating
                hypotheses before scaling features or pricing changes.</li>
            <li>Both can be mapped to <b>API endpoints</b> and <b>user
        ...
        <ul type=disc>
            <li>Prospective patterns let you
                explore <b>potential future behaviours</b>, not just optimise current
                ones.</li>
            <li>Instead of waiting for natural
                user behaviour, you <b>simulate conditions</b> that help validate
                direction early.</li>
            <li>These are ideal for <b>testing
                    innovation hypotheses</b> and product expansion ideas where historical
                data is limited.</li>
        </ul>

        <p style='line-height:normal'><b>Type of Data</b></p>

        <ul type=disc>
            <li><b>Simulated Usage Signals</b>:
                Clicks on fake or low-fidelity features.</li>
            <li><b>User Intent Signals</b>:
                Surveys, heatmaps, prototype engagement.</li>
            <li><b>Pre-engagement Metrics</b>:
                Scroll depth, dwell time, CTA hover behaviour.</li>
        </ul>

        <p style='line-height:normal'><b>Key Usability Analytics Metric</b></p>

        <ul type=disc>
            <li><b>Prospect-to-Interest Rate</b>:
                % of users who engage with a forward-looking test element.</li>
            <li><b>Signal-to-Build Ratio</b>:
                Number of validated signals per prototype or test asset.</li>
            <li> <b>Time to Decision</b>: How
                quickly PMs can move from hypothesis to actionable insight.</li>
        </ul>

        <p style='line-height:normal'><b>AI Application</b></p>

        <ul type=disc>
            <li><b>Prompt-driven Prototype
                    Builders</b>: Use GenAI to mock up feature previews or simulate
                functionality.</li>
            <li><b>User Response Prediction
                    Models</b>: Forecast which segments are most likely to engage with new ideas.</li>
            <li><b>Smart Survey Assistants</b>:
                Tailor follow-up questions based on early user responses<br>
                <br>
            </li>
        </ul>
    ...
    <section data-subitem-id="productanalyticsai-consumer-analytics-stats-for-decisions">
        ...
        <p>Statistics shouldn't feel intimidating as long as think of
            it as your toolset for making smarter decisions. AI simplifies the heavy
            lifting, quickly revealing statistically meaningful insights. With just enough
            statistical knowledge, you'll confidently turn analytics into decisions that
            genuinely move the needle for your product.</p>

        <p>&nbsp;</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 3"
                src="./images/productsanalyticsai/consumeranalytics/image016.png"
                alt="Create an image for DeftAgile's website based on the following scenario: Imagine you run an online health and wellness store. You've launched a new product page layout. Rather than manually analyzing customer interaction data, you employ an AI-powered analytics tool. It swiftly identifies a statistically significant increase in conversions due to the new layout. This clear, AI-enhanced insight helps you confidently roll out the design site-wide. The image should visually represent the scenario, incorporating elements like an online store interface, AI analytics, and a conversion increase indicator. Ensure the design aligns with DeftAgile's branding requirements.">
        </p>

        <p><b><span style='color:black'>&nbsp;</span></b></p>

        <p>Imagine you run an online health and wellness store. You've
            launched a new product page layout. Rather than manually analysing customer
            interaction data, you employ an AI-powered analytics tool. It swiftly
            identifies a statistically significant increase in conversions due to the new
...
<section data-subitem-id="productanalyticsai-consumer-analytics-separating-laggards-vs-innovators">
        ...
        <p>Understanding your customers isn’t just about demographics,
            it is about recognising adoption behaviours. With AI-driven segmentation,
            you'll confidently distinguish real signals from noise, avoiding common
            pitfalls like false positives or negatives. Tailoring your analytics to
            customer types means making decisions that truly resonates and making sure your
            innovations hit the mark every time</p>

        <p>&nbsp;</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 620925690"
                src="./images/productsanalyticsai/consumeranalytics/image017.jpg" alt="Generated image"></p>

        <p><b><span style='color:black'>&nbsp;</span></b></p>

        <p>You manage an online electronics retailer launching an
            innovative home automation product. Using AI-driven customer segmentation, you can
            identify early adopters who quickly embrace new technologies. You specifically
            target this segment first, validating the product idea effectively. In
            contrast, AI clearly flags feedback from laggards who prefer established
            solutions which helps to avoid premature dismissal or misinterpretation of
            market response</p>
...
<section data-group-id="group-productanalyticsai-demand-value-analytics">  
    ...
    <p>A Demand/Value Hypothesis are assumptions based on the
        ...
        to its target audience. It's a foundational concept often explored in product
        development. The whole point of testing hypotheses is to ensure that product
        teams are making sure the customer has a seat at the table of product creation
        i.e., giving the customer what they truly want</p>

    <p><b>Here's a breakdown of the components of a Demand/Value
            Hypothesis</b>:</p>

    <p><b>Demand Side:<br>
        </b>Who are the target customers for the product or service?<br>
        What problem or need are these customers trying to address?<br>
        How significant is the demand for a solution to this problem or need?</p>

    <p><b>Value Proposition:</b></p>

    <ul>
        <li>What unique value does the product or service offer to customers?</li>

        <li>How does the product or service address the identified problem or
            need?</li>

        <li>What makes the offering stand out from alternatives in the
            market?</li>
    </ul>
    <p><b>Assumptions:</b></p>

    <ul>
        <li>What assumptions are being made about customer preferences,
            behaviours, and the market?</li>

        <li>Are there specific features, benefits, or attributes that are
            assumed to be particularly attractive to the target audience?</li>
    </ul>
    <p><b>Metrics and Measurement:</b></p>

    <ul>
        <li>How to measure and quantify demand?</li>

        <li>What metrics will be used to assess the perceived value of the
            product or service?</li>
    </ul>
    <p><b>Testing and Validation:</b></p>

    <ul>
        <li>What methods will be employed to test the hypothesis?</li>

        <li>How will customer feedback and data be collected to validate or
            refine assumptions?</li>
    </ul>
    ...
    <p>&quot;When targeting [<b>25-35-year-old males</b>], there
            ...
            compared to existing solutions in the market. We believe that customers will be
            willing to pay a premium for these additional benefits, resulting in strong
    ...
    <p>Instead of building in the dark, the Lean Startup mindset
        ...
        clarity on what people actually want before investing time, money, and your
        team’s energy. It’s not about building less, it’s about learning more so that
        when you do build, you hit the mark.</p>

    <p>Imagine launching an online subscription box service for
        premium snacks. Before fully developing the product, you create a simple
        landing page describing the concept. Using AI sentiment analysis on initial
        feedback from social media and interviews, you quickly detect significant
        excitement around healthy snack options. Meanwhile, predictive demand models
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-demand-testing-strategies">
    ...
    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  width="600" height="300"
            src="./images/productsanalyticsai/demandvalueanalytics/image001.png"
            alt="Create an image for demand testing strategies based on software-as-a-service examples, layering in specific tactics like fake door tests, waitlists, and pricing experiments.">
    </p>

    <p>Demand testing is your early warning system. Before diving
        deep into development, you check if the water’s even warm. It’s scrappy, fast,
        and incredibly smart. And when paired with analytics and AI, it becomes your
        decision accelerator by making sure your product vision lines up with
        real-world desire.</p>

    <p>Consider you're launching an online learning platform
        offering short cooking classes. You quickly build a basic landing page
        describing the concept. An AI-powered analytics platform automatically
        evaluates initial user interactions and funnel metrics, quickly highlighting
        high engagement in vegan and healthy cooking classes. The real-time demand
        predictions guide you to prioritise content development in these high-demand
        areas confidently.</p>

    <p><b>&nbsp;</b></p>

    <p><b>Demand Testing Strategies for
            an eCommerce Website</b></p>

    <p align=center style='text-align:center;line-height:normal'><img class="img-fluid rounded-corners mt-3"  width="600" height="300"
            src="./images/productsanalyticsai/demandvalueanalytics/image002.png"
            alt="Create an image for demand testing strategies based on software-as-a-service examples."></p>
    ...
    <ul type=disc>
        ...
        <li>Track referral clicks,
            engagement rates, and basket conversions.</li>
        <li>Apply your inclusive visuals to
            make each collection feel representative and authentic.</li>
    </ul>
    ...
    <ul type=disc>
        ...
        <li>Test different angles:
            affordability, eco-friendliness, convenience, etc.</li>
        <li>Use CTR, add-to-cart rates, and
            bounce rates to determine strongest messaging.</li>
    </ul>

    <p><b>6. Wizard of Oz Checkout
            Simulation</b></p>
    ...
    <ul type=disc>
        ...
        <li>Let user’s “checkout” from a
            mock storefront.</li>
        <li>Follow up manually with email
            saying their order is being processed or part of a test.</li>
        <li>Observe dropout points, cart
            abandonment trends, and checkout flow friction<span style='font-size:9.0pt'>.</span></li>
    </ul>
    ...
    <div class="table-responsive">
        ...
        <thead class='table-light'>
            <tr>
                <td>
                    <p align=center><b><span style='color:black'>Strategy</span></b></p>
                </td>
                <td>
                    <p align=center><b><span style='color:black'>Primary Metrics</span></b></p>
                </td>
                <td>
                    <p align=center><b><span style='color:black'>Secondary Metrics</span></b></p>
                </td>
            </tr>
        </thead>
        <tr>
...
normal'>Pre-order volume. </p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'>Drop-off
                    rate.</p>
            </td>
            <td valign=top style='border:none;border-bottom:solid #666666 1.0pt;
...
background:#CCCCCC;padding:0cm 5.4pt 0cm 5.4pt'>
                <p style='margin-bottom:0cm;line-height:
normal'><span style='color:black'>Feedback sentiment (from surveys)</span></p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'><span
                        style='color:black'>Device type or screen size usage</span></p>
            </td>
        </tr>
        <tr>
            <td valign=top style='border-top:none;border-left:none;border-bottom:solid #666666 1.0pt;
...
normal'>Engagement rate (likes/comments). </p>
                <p style='margin-bottom:0cm;line-height:
normal'>Add-to-cart ratio.</p>
            </td>
            <td valign=top style='border:none;border-bottom:solid #666666 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p style='margin-bottom:0cm;line-height:
normal'>Social shares</p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'>Follower
                    growth during campaign</p>
            </td>
        </tr>
        <tr>
            <td valign=top style='border-top:none;border-left:none;border-bottom:solid #666666 1.0pt;
...
normal'><span style='color:black'>Cost per click (CPC). </span></p>
                <p style='margin-bottom:0cm;line-height:
normal'><span style='color:black'>Conversion rate.</span></p>
            </td>
            <td valign=top style='border:none;border-bottom:solid #666666 1.0pt;
background:#CCCCCC;padding:0cm 5.4pt 0cm 5.4pt'>
                <p style='margin-bottom:0cm;line-height:
normal'><span style='color:black'>Return on ad spend (ROAS)</span></p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'><span
                        style='color:black'>Geo or demographic breakdown</span></p>
            </td>
        </tr>
        <tr>
            <td valign=top style='border-top:none;border-left:none;border-bottom:solid #666666 1.0pt;
...
normal'>Abandonment rate.</p>
                <p style='margin-bottom:0cm;line-height:
normal'>Interaction heatmaps.</p>
            </td>
            <td valign=top style='border:none;border-bottom:solid #666666 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p style='margin-bottom:0cm;line-height:
normal'>Feedback submissions</p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'>Session
                    replay engagement (if available).</p>
            </td>
        </tr>
        <tr>
            <td valign=top style='border-top:none;border-left:none;border-bottom:solid #666666 1.0pt;
...
background:#CCCCCC;padding:0cm 5.4pt 0cm 5.4pt'>
                <p style='margin-bottom:0cm;line-height:
normal'><span style='color:black'>Hypothesis alignment. score.</span></p>
                <p class=MsoListParagraphCxSpLast style='margin-bottom:0cm;line-height:normal'><span
                        style='color:black'>Qualitative patterns. across user profiles.</span></p>
            </td>
        </tr>
    </table>
    </div>
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="650" height="300" id="Picture 33"
            src="./images/productsanalyticsai/demandvalueanalytics/image003.png"></p>

    <p align=left style='text-align:right'>Dr Kushner: <a
            href="https://www.youtube.com/watch?v=xDWdJI_XT3k&amp;t=9s">Experimental
            Design: Variables, Groups, and Random Assignment</a></p>

    <p align=right style='text-align:right'>&nbsp;</p>

    <p>Experiments aren’t just about running tests; they are also
        about asking good questions and getting clear answers. With a focused design,
        your experiments stop being noisy guesses and start becoming sharp tools for
    ...
    <p>You create a multivariate testing where one group sees different
        ...
        AI-driven analytics tool automatically tracks customer interactions, rapidly
        providing insights into conversion lifts due to ad variations and landing page.
...
line-height:107%'>We believe that removing paintpoints from our customer
    ...
    <p><span style='font-size:12.0pt;line-height:107%'>In our
            ...
            pages will lead to a significant increase in total sales. Let's break down the
            hypothesis and identify the variables involved</span></p>

    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300"
            src="./images/productsanalyticsai/demandvalueanalytics/image004.png"
            alt="Create a visual diagram summarizing the experimental design for a marketing strategy. Include the following elements: Independent Variables (Paid Ads Improvement and Landing Page Improvement), Dependent Variable (Total Sales with a 40% increase target), Control Variables (Other Marketing Channels and External Conditions), Moderating Variables (Customer Behaviour and Competitor Actions), and Mediating Variables (User Experience and Conversion Rate). Use a clean, professional style with clear labels and connections.">
    </p>

    <p align=center style='text-align:center'><span style='font-size:12.0pt;line-height:107%'>&nbsp;</span></p>
    ...
    <p>These variables collectively form the basis for our
        ...
        considering and controlling these factors, we can also gain insights into the
        impact of our proposed improvements on the desired outcome, which is the
        increase in total sales.</p>
...
margin-bottom:0cm;margin-left:72.0pt;text-indent:-18.0pt;line-height:normal'>d.<span
    ...
    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
            src="./images/productsanalyticsai/demandvalueanalytics/image005.png"
            alt="Create an image for the 8 steps for MVP experiment design. Ensure alignment with DeftAgile's branding requirements, including stick persons representing various ethnic backgrounds: Step 1 – Define the Core Hypothesis, Step 2 – Identify the Riskiest Assumption, Step 3 – Select the Right MVP Format, Step 4 – Define Success Metrics, Step 5 – Build the Smallest Testable Product, Step 6 – Run the Experiment, Step 7 – Capture and Analyse Data, Step 8 – Make a Decision.">
    </p>

    <p>Building MVPs isn't just about speed; it is also about smart
        experimentation. Carefully designed MVPs let you quickly test your most
        critical assumptions with minimal resources. Integrating AI helps turn quick
        tests into confident, data-driven decisions, ensuring your e-commerce product
        evolves exactly where your customers lead you.</p>

    <p>Imagine launching an MVP for an e-commerce site selling
        sustainable home products. You initially offer only a limited range of products
        on a simplified website. AI quickly analyses user feedback and behavioural
        data, identifying that eco-friendly kitchenware has significantly higher
        engagement. Leveraging these insights, you confidently expand your MVP to focus
        on kitchenware, effectively validating market demand.</p>

    <p><b>What is an MVP in Experiment
            Design?</b></p>

    <p>An MVP is the <b>smallest,
            simplest version of a product</b> that allows you to test your riskiest
        assumptions with real users quickly, cheaply, and with minimal engineering
        effort.</p>

    <p>In experiment design, the MVP is
    ...
    <ul type=disc>
        <li><b>Validate before you build</b>
            – Reduce risk by testing assumptions before investing heavily.</li>
        <li><b>Accelerate feedback loops</b>
            – Gather actionable user insights fast.</li>
        <li><b>Minimise waste</b> – Avoid
            overbuilding features users don’t want or understand.</li>
        <li><b>Test real behaviour</b> –
    ...
    <p><b>Step 1 – Define the Core
            Hypothesis</b></p>

    <p>A good experiment starts with a <b>clear,
    ...
    <p>Focus on the assumption that, if
        wrong, would most likely kill the idea.</p>

    <ul type=disc>
        <li><b>Types of risks:</b></li>
    </ul>
...
normal'>d)<span>&nbsp;&nbsp;&nbsp;&nbsp; </span>Business
    ...
    <p>Different MVP types match
        different risks:</p>

    <ul type=disc>
        <li><b>Fake Door MVP</b> – Test
            demand by showing the feature in the UI but not delivering it yet.</li>
        <li><b>Landing Page MVP</b> –
            Describe the product/feature and track sign-ups or clicks.</li>
        <li><b>Wizard of Oz MVP</b> –
            Deliver the experience manually while faking automation.</li>
        <li><b>Concierge MVP</b> – Manually
            serve each customer to learn what they value most.</li>
        <li><b>Prototype MVP</b> –
            Interactive mock-ups to test usability.</li>
        <li><b>Single Feature MVP</b> –
            Release just the one core capability.</li>
    </ul>

    <p><b>Step 4 – Define Success
            Metrics</b></p>

    <p>Your metrics should directly
        validate or invalidate the hypothesis.</p>

    <ul type=disc>
        <li><b>Quantitative examples:</b></li>
    </ul>

    <ul type=disc>
        <ul type=disc>
            <li>Conversion rate ≥ X%</li>
            <li>Task completion rate ≥ Y%</li>
            <li>Drop-off rate ≤ Z%</li>
        </ul>
    </ul>

    <ul type=disc>
        <li><b>Qualitative examples:</b></li>
    </ul>

    <ul type=disc>
        <ul type=disc>
            <li>Feedback sentiment (positive
                vs negative themes)</li>
            <li>Observable behaviour changes</li>
        </ul>
    </ul>

    <p><b>Step 5 – Build the Smallest
            Testable Product</b></p>

    <ul type=disc>
        <li>Keep <b>scope minimal</b> —
            focus on the one feature or flow that tests the hypothesis.</li>
        <li>Cut non-essential
    ...
    <ul type=disc>
        <li>Test with <b>real users</b>
            (not just internal staff).</li>
        <li>Use a <b>representative segment</b>
            from your target audience.</li>
        <li>Choose a short, fixed <b>timebox</b>
            to limit cost and accelerate learning.</li>
    </ul>

    <p><b>Step 7 – Capture and Analyse
            Data</b></p>

    <ul type=disc>
        <li>Combine <b>quantitative
                analytics</b> (e.g., click-through rates, conversion funnels) with <b>qualitative
                insights</b> (e.g., interviews, usability observations).</li>
        <li>Look for <b>patterns</b>, not
            just isolated events.</li>
    </ul>

    <p><b>Step 8 – Make a Decision</b></p>

    <ul type=disc>
        <li><b>Persevere</b> – Results
            validate your hypothesis → invest further.</li>
        <li><b>Pivot</b> – Results suggest
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-the-hook-framework">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300" id="Picture 1052179703"
            src="./images/productsanalyticsai/demandvalueanalytics/image006.png"
    ...
    <p>Forming user habits isn't about chance—it's about
        ...
        meaningful investments. By using AI to tailor these elements, your e-commerce
        store won’t just attract customers—it'll become an essential part of their
        routines, driving sustainable growth and loyalty.</p>

    <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="600" height="300" id="Picture 3"
            src="./images/productsanalyticsai/demandvalueanalytics/image007.png"></p>

    <ol style='margin-top:0cm' start=1 type=1>
        <li><b>Trigger</b> External cues (emails, ads, icons) spark
            engagement, which over time link to internal triggers (emotions, routines,
            contexts) that drive behaviour.</li>
        <li><b>Action</b> Customers act when motivation is high and
            effort is low. Simplify access to reduce friction and encourage
            conversion.</li>
        <li><b>Variable Reward</b> Unpredictable rewards like info,
            social validation, entertainment, keeping users engaged and coming back
            for more.</li>
        <li><b>Investment</b> After receiving value, users invest
            effort (e.g., signup, post, purchase), comments for likes hence reinforcing
    ...
    <p>Imagine you run an online fitness apparel store. Using the
        ...
        workout apparel arrives, customised by AI analysis of past customer
        preferences. After customers purchase (action), they receive variable rewards
        like personalised workout tips and discount codes for future purchases. As they
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-6-experiment-charters">
    ...
    <p>Experiment charters help us cut through the noise. Instead
        of launching vague tests and hoping for insight, you're designing tight,
        focused probes into what really matters. And with AI watching the details,
        you'll learn faster, test smarter, and get to product-market fit with your eyes
        wide open</p>

    <p>You manage a beauty subscription box. You want to test
        whether adding “Free Trial” messaging improves sign-ups. You write an
        experiment charter:<br>
        <b>Hypothesis:</b> “If users see ‘Free Trial,’ they'll be more likely to sign
        up.”<br>
        You A/B test headlines. AI tools tag user interaction patterns and show mobile
        users responded 2× better to trial offers, guiding your mobile-specific content
        strategy.
    </p>
    ...
    <ul type=disc>
        <li><b>Fake Door Test Charter</b> –
            Launch a button, menu option, or page that suggests a feature exists, then
            measure click-throughs or sign-ups.</li>
        <li><b>Landing Page Test Charter</b>
            – Build a marketing-style page describing the feature/product to gauge
            interest via conversion rates.</li>
        <li><b>Pre-Order or Sign-Up Test
                Charter</b> – Offer early access or pre-purchase to test real intent to
            buy.</li>
    </ul>
    ...
    <ul type=disc>
        <li><b>Prototype Usability Test
                Charter</b> – Use clickable Figma or InVision prototypes to observe users
            completing key tasks.</li>
        <li><b>Wizard of Oz Test Charter</b>
            – Fake automated behaviour behind the scenes with human intervention to
            validate usability without building full tech.</li>
        <li><b>A/B UI Test Charter</b> –
            Compare two interface versions to see which drives better task completion
            rates.</li>
    </ul>
    ...
    <ul type=disc>
        <li><b>Technical Spike Charter</b>
            – Short, time-boxed exploration to prove a technical concept works.</li>
        <li><b>Integration Feasibility Test
                Charter</b> – Test if APIs or third-party systems can integrate as
            planned.</li>
        <li><b>Performance Benchmark
                Charter</b> – Run a controlled test to ensure performance meets customer
            expectations.</li>
    </ul>
    ...
    <ul type=disc>
        <li><b>Referral Mechanism Test
                Charter</b> – Test different referral incentives to see which maximises
            shares.</li>
        <li><b>Pricing Sensitivity Charter</b>
            – Experiment with different price points or packaging to measure revenue
            and conversion impact.</li>
        <li><b>Engagement Loop Test Charter</b>
            – Test habit-forming features (e.g., notifications) for retention lift.</li>
    </ul>
    ...
    <ul type=disc>
        <li><b>Hook Framework Test Charter</b>
            – Validate triggers, actions, rewards, and investment loops.</li>
        <li><b>Onboarding Flow Optimisation
                Charter</b> – Test different onboarding sequences to reduce drop-off.</li>
        <li><b>Nudge &amp; Prompt Test
                Charter</b> – Experiment with reminders or prompts to encourage target
            behaviours.</li>
    </ul>
    ...
    <ul type=disc>
        <li><b>Cohort Retention Test
                Charter</b> – Track retention rates for a defined customer segment after
            onboarding.</li>
        <li><b>Segment Fit Test Charter</b>
            – Test adoption rates across different customer personas.</li>
        <li><b>Job-to-Be-Done Fit Charter</b>
            – Validate if the product truly solves the core “job” for a user segment.</li>
    </ul>

    <p><b>Pro tip for Product Managers:</b><br>
        Each experiment charter should contain:</p>

    <ol start=1 type=1>
        <li><b>Hypothesis</b> – Clear,
            measurable statement of what you expect to happen.</li>
        <li><b>Customer Segment</b> – Who
            you’re testing with.</li>
        <li><b>Method</b> – How you’ll run
            the experiment.</li>
        <li><b>Metrics for Success</b> –
            Specific, quantifiable measures.</li>
        <li><b>Timeframe</b> – Duration and
            data collection window.</li>
        <li><b>Decision Rules</b> – What
    ...
    <table class=MsoNormalTable border=1 cellpadding=0 style='margin-left:-11.45pt;
...
12.0pt'> AI Applications:</span></b></p>
 ...
 12.0pt'>Charter Generator AI</span></b><span>:
    ...
    <p>The fake feature test is like throwing a party invite to see
        ...
        revealing. And with AI watching the guest list and listening to the chatter,
        you’ll know exactly what to build, who to build it for, and when to double down</p>

    <p>&nbsp;</p>

    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
            src="./images/productsanalyticsai/demandvalueanalytics/image009.png"
            alt="Create a fake feature test image based on this example: Your home goods store wants to test a “Design My Room” feature. Instead of building it, you add a “Try Room Designer” button on product pages. AI tracks who click, how often, and what users do next. Feedback clustering reveals strong demand from users browsing furniture bundles. That’s your green light to build a prototype—focused on bundle shoppers">
    </p>

    <p>Your home goods store wants to test a “Design My Room”
        feature. Instead of building it, you add a “Try Room Designer” button on
        product pages. AI tracks who click, how often, and what users do next. Feedback
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-running-the-experiment">
    ...
    <p>Designing a great experiment is only half the battle—running
        it right is what gives you trustworthy insight. And with AI acting like your
    ...
    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
            ...
            alt="change word metrica in images to metrics and the word optimized to optimised. Shorten the image text copy">
    </p>

    <p>Your online electronics store wants to test whether a
        product comparison table increases conversions. You roll it out to 50% of
        users. AI tools monitor key metrics in real time, automatically flagging that
...
padding:0cm 5.4pt 0cm 5.4pt'>
    ...
    <p>This funnel focuses on the commercial journey from discovery
        to brand evangelism.</p>

    <p align=center><img class="img-fluid rounded-corners mt-3"  border=0 width="650" height="350" id="Picture 1726581986"
            src="./images/productsanalyticsai/demandvalueanalytics/image012.png" alt="Generated image"></p>
...
padding:0cm 5.4pt 0cm 5.4pt'>
    ...
    <p style='text-align:justify'>“It's about how to develop a model
        of your customer behaviour, and then use conversion metrics /web analytics to
        assist your internet marketing &amp; product management efforts”</p>

    <p style='margin-left:252.0pt;text-align:justify'><a name="_Hlk205714810">(Dave Mclure: 500 hats
            blog June 20 2007)</a></p>

    <p style='text-align:justify'>Mclure’s aim was to show young
        companies how to narrow their focus only on metrics that can directly Impact
        the health of their business. Second, help these companies use the right data
        to gauge the success of their product management and marketing efforts, then
        improve those initiatives that aren’t working. This will help with the
        collection of data and making decisions.</p>
    ...
    <p style='margin-left:252.0pt;text-align:justify'>(Dave Mclure:
        500 hats blog June 20 2007)</p>
...
padding:0cm 5.4pt 0cm 5.4pt'>
    ...
    <p align=center style='text-align:center'>Purchase funnel</p>

    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
            src="./images/productsanalyticsai/demandvalueanalytics/image014.png" alt="Generated image"></p>
...
border-left:none;padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Run paid ads and measure
                    impressions vs. clicks.</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Use retargeting ads and product
                    comparison tools to test influence</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p> A/B test pricing, shipping
                    options, and payment methods.</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Offer rewards for repeat
                    purchases and test referral incentives</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Encourage reviews and social
                    sharing; test incentives for user-generated content</p>
            </td>
        </tr>
    </table>
    </div>
...
padding:0cm 5.4pt 0cm 5.4pt'>
            ...
            <td width=450 valign=top style='width:337.65pt;border:solid windowtext 1.0pt;
border-left:none;padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Publish thought leadership
                    content and measure traffic sources.</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Test free vs. freemium models
                    and feature gating.</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Run experiments on pricing
                    tiers and trial-to-paid conversion flows</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Use NPS surveys and test
                    customer success outreach</p>
            </td>
        </tr>
        <tr>
            <td width=103 valign=top style='width:77.15pt;border:solid windowtext 1.0pt;
...
none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
padding:0cm 5.4pt 0cm 5.4pt'>
                <p>Track referral program
                    performance and test testimonial requests.</p>
            </td>
        </tr>
    </table>
    </div>
    ...
    <p><span>Your fashion
            ...
            increase in funnel completion for first-time buyers.</span></p>
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-testing-cohorts">
    ...
    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 747718648"
            src="./images/productsanalyticsai/demandvalueanalytics/image015.png"
            alt="Create a cohort image of cohort acquisition and retention (or dropoff) over time"></p>

    <p>Cohorts show you what the average can’t. They spotlight
        patterns and possibilities hidden in your user base. And when AI helps surface
        insights and suggest action, you go from ‘why is this happening?’ to ‘let’s fix
        it’ faster than ever</p>

    <p>You run a home decor store and notice overall revenue is
        flat. AI-powered cohort analysis reveals users who joined via your Pinterest
        campaign two months ago have high engagement but poor conversion. You launch a
        targeted free shipping test for this cohort, boosting purchases by 18%.</p>

    <p align=center style='text-align:center'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287"
            src="./images/productsanalyticsai/demandvalueanalytics/image016.png"
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-part-1-experiment-design">
    ...
    <p><span>You’re
            ...
            which segments (freelance designers vs. enterprise managers) show the highest
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-part-2-experiment-execution">
    ...
    <p><span>You’re
            ...
            sign-ups are high, managers drop off faster than designers. NLP feedback
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-ai-enhanced-experiment-lifecycle-testing">
    ...
    <h2 align=center id="productanalyticsai-demand-value-analytics-ai-enhanced-experiment-lifecycle-testing">
        AI-Enhanced
        Experiment Lifecycle – Testing a New
        Electronic Product for Designers &amp; Managers</h2>

    <p align=center style='text-align:center;line-height:normal'><img class="img-fluid rounded-corners mt-3"  border=0 width="431" height="287" id="Picture 1"
...
<section data-subitem-id="productanalyticsai-demand-value-analytics-diverging-your-ideas-with-generative-ai">
    ...
    <h2 align=center id="productanalyticsai-demand-value-analytics-diverging-your-ideas-with-generative-ai">
        Diverging Your
        Ideas with Generative
        AI</h2>

    <p>Think of generative AI as your brainstorm buddy who never
        gets tired. It’s not here to replace your ideas but it’s here to unlock new
        ones you wouldn’t have thought of alone. When you pair that creativity with
        smart analytics, you're not just iterating, you are also inventing with purpose</p>

    <p>You’re testing new upsell strategies for your online fitness
        equipment store. Your prompt ChatGPT: “Suggest 10 creative post-checkout upsell
        messages that feel helpful, not pushy.” It responds with ideas like “Your foam
        roller is a great match for this stretching strap, do want to add it now?” You
        A/B test the top 3. AI-generated copy wins a 15% lift in upsell conversions</p>
...
12.0pt'>AI Applications:</span></b></p>
 ...
 12.0pt'>: Combine AI idea generation with automated validation tools
    ...
    <p><span>Demand &amp;
            ...
            riskiest assumptions. The message is clear: don’t wait until launch to discover
...
<section data-subitem-id="productanalyticsai-usability-analytics-usability-hypothesis">
    ...
    <p>A Usability Hypothesis is a statement that outlines
        ...
        interface. It is commonly used in user experience (UX) design and usability
        testing to guide the evaluation and improvement of the overall user experience.
        The hypothesis helps in framing specific aspects of usability that designers or
        researchers believe are important and need validation.</p>
    ...
    <p>&quot;For our e-commerce website, we hypothesise that by
            ...
            that users find the current navigation confusing and that a more
            straightforward checkout process will lead to a better overall user experience.
    ...
    <p>This hypothesis serves as a guide for usability testing and
        ...
        experience and provides a basis for measuring the success of usability
...
<section data-subitem-id="productanalyticsai-usability-analytics-tracking-key-outcomes">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" src="./images/productsanalyticsai/usabilityanalytics/image001.png"
            alt="Generated image"></p>

    <p>If you’re not measuring the right outcome, you’ll end up
        fixing the wrong thing. Google Analytics can tell you what happened, but when
        you connect that to a strong dependent variable, it starts telling you what
...
<section data-subitem-id="productanalyticsai-usability-analytics-google-analytics-for-usability">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" src="./images/productsanalyticsai/usabilityanalytics/image002.png"
            alt="Create a Google Analytics image with sessions, events and goals"></p>

    <p>You don’t need to master every corner of Google Analytics;
        all you need to tune it to what matters for your product. A few well-placed
...
<section data-subitem-id="productanalyticsai-usability-analytics-design-to-code-tracking">
    ...
    <p>Analytics shouldn’t be added after a feature is done, they
        should ride the shotgun from day one. When product, design, and dev teams build
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Amplitude</span></strong>
        ...
        due to a missing default option. A fix was deployed, and usage of the new
        module climbed 24% in a week.</p>

    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 106500974"
            src="./images/productsanalyticsai/usabilityanalytics/image003.png"
...
<section data-subitem-id="productanalyticsai-usability-analytics-code-to-analytics-loop">
    ...
    <p><b><span>Dropbox</span></b><span> built an internal tool
            ...
            and sped up funnel analysis for PMs by over a week per release.<br>
            <br>
        </span></p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-ab-testing">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 4"
            src="./images/productsanalyticsai/usabilityanalytics/image005.png"
            alt="Create an image for A/B testing for an e-commerce website"><img class="img-fluid rounded-corners mt-3"  width="431" height="287"
            src="./images/productsanalyticsai/usabilityanalytics/image006.png"
            alt="Create an image for A/B testing for a SaaS website"></p>

    <p align=center><b><span style='font-size:14.0pt;line-height:107%'>&nbsp;</span></b></p>

    <p>A/B testing helps you settle product debates with data, not
        opinions. And when you layer in smart analytics and AI, you’re not just testing
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Dropbox</span></strong>
        ...
        more with the version including tooltips, while casual users preferred
        simplicity. Dropbox rolled out both, tailored to user type resulting in a 14%
        lift in file-sharing activity across both segments</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-mapping-for-insights">
    ...
    <p>Analytics only tell a great story when they follow one. When
        you align your tracking with user goals, everything becomes clearer: what’s
        working, what’s confusing, and what’s ready for the next iteration. Your
        product manager is right; you don’t need more metrics. You need more meaning.</p>
    ...
    <p>Product teams can make better decisions when every user
        ...
        mapping stories to metrics, provides example mappings in e-commerce and SaaS
        contexts, highlights common pitfalls (with solutions), and recommends tools and
        best practices for this process.</p>

    <p><b>Loom </b>mapped analytics to a
        simple story: “Record, Review, Share.” When sales calls revealed users felt
        unsure about next steps after recording, the team aligned events to this flow
        and noticed a significant drop-off between “Review” and “Share.” They added a
        lightweight tooltip and visual cues, leading to a 19% increase in share
        completion.</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-user-stories-analytics-e-commerce">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" src="./images/productsanalyticsai/usabilityanalytics/image009.png"
            alt="Edit the e-commerce image to include a shopper with a laptop."><img class="img-fluid rounded-corners mt-3"  width="431" height="287"
...
font-family:"Inter",sans-serif'>&nbsp;</span></strong></p>
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Slack</span></strong>
        ...
        overall but AI-driven path analysis revealed some users skipped straight to
        file uploads. This unexpected insight led to a new story focused on encouraging
        early content sharing, not just conversation.</p>

    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 976633890"
            src="./images/productsanalyticsai/usabilityanalytics/image011.png"
            alt="Create a descriptive image illustrating Slack's new onboarding story encouraging new users to send a message right after joining a workspace. Depict the pairing of the story with a usage metric: first message sent within 5 minutes. Highlight analytics showing overall success, but AI-driven path analysis revealing some users skipped straight to file uploads. Emphasize the new story focused on encouraging early content sharing, not just conversation.">
    </p>
    ...
    <ol style='margin-top:0cm' start=1 type=1>
        ...
        <li><b>Include Analytics in Acceptance Criteria and Definition
                of Done</b> – Treat instrumentation as a first-class part of development,
            ...
            and QA verifying those events fire correctly.</li>
        <li><b>Implement and Instrument the Story</b> – As the feature
            ...
            Aim for a reasonable number of events covering key actions (too many
            events can overwhelm analysis). Importantly, treat analytics code with the
            same diligence as production code<b>: test </b>that events fire correctly
            (no duplicate or missing fires, correct data payloads) before releasing.
            Many teams extend their QA process to include validating analytics events,
            ensuring data quality from day one.</li>
        <li><b>Collect Data and Analyse Outcomes</b> – Once the story
            is live and data is flowing, monitor the metrics tied to that story. Use
            your analytics tools to see how users are interacting with the new feature
            or change. For example, track the event counts or funnel conversion rates
            related to the story over time. Compare against the baseline or target
            defined earlier. If the story introduced an experiment (A/B test or
            feature flag), wait for statistically significant results before drawing
            conclusions. Analytics dashboards or funnel reports can illustrate whether
        ...
        <li><b>Learn and Iterate</b> – Finally, feed the insights back
            ...
            that success with the team). If the metrics fell short, treat it as valuable
            learning: figure out why and decide on next actions. This could mean
            refining the feature, trying a different solution, or even rolling back
            changes. For instance, if analytics show a low adoption of a new feature,
            the team might plan a follow-up story to improve discoverability or user
            onboarding for that feature. The key is to adapt the product backlog based
            on data – prioritise new user stories or tweaks that address the observed
            issues. This closes the loop, ensuring product development is continuously
            guided by evidence. Teams can even create new user stories specifically
            for analytics improvements (e.g. adding a new metric or report needed to
            gain insight) as they realise gaps in data.</li>
    </ol>

    <p>By following these steps, product teams embed measurement
        into their Agile process. Every story moves through a <b>build-measure-learn</b>
        cycle, which supports data-driven decision-making at each iteration.</p>
    ...
    <ul style='margin-top:0cm' type=disc>
        <ul style='margin-top:0cm' type=disc>
            <li><b>Filter Usage Rate</b> – what percentage of users who
                search or browse use the filters.</li>
            <li><b>Post-Filter Conversion</b> – purchase or add-to-cart
                rate for sessions where filtering was used vs. not used.</li>
            <li><b>Drop-off after Filtering</b> – whether applying
                filters leads to “no results” and user exits (a potential UX issue).</li>
        </ul>
    </ul>

    <ul style='margin-top:0cm' type=disc>
        <li><b>Instrumentation</b>: As part of development, the team
        ...
        <li><b>Outcome Analysis</b>: After release, the product
            ...
            a conversion rate of 5% (vs 3% for those who don’t filter) – a positive
        ...
        <li><b>Resulting Decisions</b>: The analytics mapping of this
...
<section data-subitem-id="productanalyticsai-usability-analytics-user-stories-analytics-saas">
    ...
    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" src="./images/productsanalyticsai/usabilityanalytics/image012.png"
            alt="For the second image that you created, change the user story to: As a user, I want to access a dashboard with key metrics so that I can monitor my account activity."><img class="img-fluid rounded-corners mt-3" 
            width="431" height="287" id="Picture 9" src="./images/productsanalyticsai/usabilityanalytics/image013.png"
            alt="Generated image"></p>

    <p><b><span style='font-size:14.0pt;line-height:107%'>&nbsp;</span></b></p>

    <p>The voice of the customer doesn’t always come from research;
        it often comes from sales. And when we take that feedback and pair it with
        smart, structured analytics, we’re not just writing better stories, we’re
        building a better SaaS product</p>
    ...
    <ul type=disc>
        <li><b>Planned Metrics/Events</b>:
            The team identifies <b>Feature Adoption</b> as the key outcome
            specifically; they expect the invite feature to increase the number of
    ...
    <p>b)<span>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        with industry patterns – many SaaS platforms track how often users invite
        others or use key features, because these metrics reveal deeper engagement. In
        our case, the data might show that if an admin fails to send any invites, that
    ...
    <p>c)<span>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></strong><b>Resulting Decisions</b>: Suppose the metrics fell
        ...
        product manager could then propose a new experiment: e.g. a guided onboarding
        step that prompts the admin to invite colleagues (with an A/B test to measure
        if it boosts the invite rate). On the other hand, if the invite feature is
        wildly successful and correlated with retention, the team might double down and
        build more features for team collaboration. In either case, mapping the user
        story to analytics ensures data, not guesswork, drives the next<b> </b>steps.
        It also provides tangible evidence to stakeholders about the feature’s impact
    ...
    <ul type=disc>
        <li>User stories are often too
            generic but pairing them with direct insights from sales conversations
            grounds them in reality.</li>
        <li>Sales objections, demo
            friction, and repeated explanations can all point to hidden usability
            issues </li>
        <li>When sales feedback gets
            translated into metrics and tracked, it becomes a driver of continuous
            product refinement.</li>
    </ul>

    <p><b>Type of Data</b></p>

    <ul type=disc>
        <li><b>Sales Call Summaries</b>:
            Notes, tags, and objections logged in CRM.</li>
        <li> <b>Demo Recordings</b>:
            Specific moments when users express confusion or surprise.</li>
        <li><b>Story Analytics Pairs</b>:
            Usage data connected directly to updated or sales-informed user stories.</li>
    </ul>

    <p><b>Key Usability Analytics Metric</b></p>

    <ul type=disc>
        <li><b>Sales-Informed Story
                Adoption</b>: Did users behave as expected after a feature inspired by
            sales feedback was launched?</li>
        <li><b>Objection-Resolution Rate</b>:
            % drop in objections tied to usability improvements.</li>
        <li><b>Conversion-Time Shift</b>:
            Did clarification or simplification reduce time from demo to activation?</li>
    </ul>

    <p><b>AI Application</b></p>

    <ul type=disc>
        <li><b>Sales-to-Story Mapping</b>:
            AI links sales objections to potential UX flaws.</li>
        <li><b>Call Transcript Topic
                Extraction</b>: Automatically surfaces themes from large call volumes.</li>
        <li><b>Outcome Prediction</b>:
            Machine learning predicts impact of usability-related story updates based
            on past patterns.<br>
            <br>
        </li>
    </ul>

    <p align=center><b><span style='font-size:14.0pt;line-height:107%'>Cross-functional Collaboration</span></b></p>

    <p>Great design doesn’t just come from product teams; it’s
        built on the voices of the people closest to your users. When sales, support,
    ...
    <p>At <strong><span style='font-family:"Inter",sans-serif'>Zendesk</span></strong>,
        ...
        ticket volume related to editor confusion dropped by 28% post-launch.</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-cross-functional-collaboration">
    ...
    <p>Product prioritisation shouldn’t feel like guesswork. When
        you treat inferences like currency based and sourced from real analytics and
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Airtable</span></strong>
        ...
        faster.” AI flagged this with strong support from behaviour data. Once
        implemented, onboarding completion time dropped by 20%</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-learning-from-competitors-with-generative-ai">
    ...
    <p>It should not be about copying the competition; it’s about
        expanding your field of view. Generative AI can introduce you to patterns you
        haven’t seen, tools you’ve never used, and workflows you hadn’t imagined. And
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Figma</span></strong>
        ...
        contextual prompts. Testing those approaches led to a 2× increase in feature
        awareness in their beta cohort.</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-analytics-on-analytics">
    ...
    <p>This is not about turning everyone into analysts. It is
        about putting usability signals where they belong which is right in the daily
    ...
    <p>At <strong><span style='font-family:"Inter",sans-serif'>Asana</span></strong>,
        ...
        detecting sessions with frequent back-clicks and long pauses, they redesigned
        the interface to surface templates sooner. Result? A 12% increase in day-one
        task creation.</p>

    <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 1217711731"
            src="./images/productsanalyticsai/usabilityanalytics/image018.png" alt="Generated image"></p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-qualitative-usability-testing">
    ...
    <p>You can have perfect analytics and still miss the real
        story. Sitting with users either virtually or in-person will let you spot the
    ...
    <p><strong><span style='font-family:"Inter",sans-serif'>Notion</span></strong>
        ...
        comments were hiding. Post-test sentiment clustering flagged the issue, leading
        to a design tweak that clarified the navigation without waiting for usage to
        drop.</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-existing-data-insights">
    ...
    <p>You don’t always need a new test,
        all you need is better lens. The data you already have is full of usability
        insights. When you slow down and look at it like a designer, not just an
    ...
    <p>At <strong><span style='font-family:"Inter",sans-serif'>Airtable</span></strong>, the
        ...
        showed many users bypassed it entirely. A redesign of the copy and structure
        increased engagement with templates by 19%.</p>
...
<section data-subitem-id="productanalyticsai-usability-analytics-field-insights">
    ...
    <p>Sometimes, your best usability testing lab is already
        running on Zoom, in chats, and over phone calls. You just have to tune in. And
    ...
    <p>At <strong><span style='font-family:"Inter",sans-serif'>Zendesk</span></strong>,
        ...
        as a feature gap. A lightweight settings enhancement followed which led to the
        reduction of related tickets by 35%.</p>
    ...
    <p>Usability
        Analytic focuses on whether people can actually use your product easily and
        effectively. It argues that usability analytics works best when it’s tied
        directly to user stories and tracked from the moment you design a feature—not
        bolted on afterward. The conclusion is that usability success isn’t just about
        clean design; it’s about instrumenting the right events, running meaningful A/B
        tests, and combining qualitative feedback with analytics to spot friction. The
        document also highlights the importance of involving sales and support teams in
        identifying usability gaps, since they hear customer pain points first. By
        making analytics a daily conversation and validating design decisions with
        evidence, teams can move from reactive fixes to proactive improvements that
        boost adoption, satisfaction, and retention.</p>
...
font-weight:normal'>Data science is the disciplined process of using data to
            ...
            products that get smarter, more efficient, and more customer-focused over time.<b><span
                    style='font-size:14.0pt;line-height:107%'> </span></b>Data science isn’t about
            building complex models for the sake of it; it’s about turning insight into
            better product choices. For SaaS teams, that means knowing when to show the
        ...
        <p><strong><span style='font-family:"Inter",sans-serif'>Mixpanel</span></strong>
            ...
            which cut drop-offs by 30% in key flows.</p>
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-data-science-and-generative-ai">
        ...
        <p>Data science gives us the roadmap and generative AI gives us
            a high-speed vehicle to explore it. For SaaS teams, this combo unlocks faster
        ...
        <p><strong><span style='font-family:"Inter",sans-serif'>Canva</span></strong>
            ...
            version created by AI saw a 15% lift in template completion during the first
            session by beating the original by a wide margin</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 2"
                src="./images/productsanalyticsai/datascienceaiproductmanagers/image002.png"
...
"Inter",sans-serif;font-weight:normal'>Predictive AI helps you see what’s
        ...
        <p>Think of predictive AI as your
            lookout, - which is scanning the horizon for what’s likely. Generative AI is
            your builder by crafting new pathways based on what you know. Together, they
...
"Inter",sans-serif'>Grammarly</span></strong> uses predictive AI to assess
            ...
            satisfied in feedback surveys.</p>
        ...
        <p>Growing your analytics and AI
            capability isn’t just about tools, it’s about habits, culture, and shared
            fluency. When product, data, and engineering teams grow together, decisions get
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-jtbd-and-ai-portfolio">
        ...
        <p>Users don’t care if your product uses AI, they only care if
            it helps them get their job done faster, better, or with less effort. When you match
        ...
        <p><strong><span style='font-family:"Inter",sans-serif'>Notion</span></strong>
            ...
            accelerating, and refined prompts and placement based on real success signals, leading
            to higher AI engagement and lower manual edit rates.</p>

        <p align="center"><img class="img-fluid rounded-corners mt-3"  width="431" height="287"
                src="./images/productsanalyticsai/datascienceaiproductmanagers/image005.png"
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-finding-ground-truth-with-ai">
        ...
        <p>Every product decision is a bet, and the best bets are made
            with clear signals. When you use AI to clarify your ground truth, you build
        ...
        <p><strong><span style='font-family:"Inter",sans-serif'>Intercom</span></strong>
            ...
            regression analysis, they found that setting up event-based targeting was the
            strongest ground truth signal. Prioritizing that feature in onboarding boosted
            paid conversion by 1</p>
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-easy-to-durable-wins-with-ai">
        ...
        <p>Easy wins are your entry point but durable wins are your
            legacy. The best SaaS teams use AI not just to dazzle, but to deliver sustained
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-working-with-data-science-teams">
        ...
        <p>Data science isn’t just an engine, it’s a conversation. When
        ...
        <p>At <strong><span style='font-family:"Inter",sans-serif'>HubSpot</span></strong>,
            ...
            next steps, and even create JIRA tickets. This process has shortened their
            decision loops by 35%</p>
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-the-hidden-dragon-case">
        ...
        <p>Sometimes the biggest product problems aren’t visible on the
            surface. They’re buried in patterns, sequences, and signals you haven’t
            stitched together yet. But when you start thinking like a data detective, every
            anomaly becomes a clue and every insight becomes a lever.</p>

        <p>Hidden Cobra is the U.S. government’s umbrella term for
            North Korean state-sponsored hacking groups like Lazarus was exposed through a
            coordinated investigation combining cyber forensics, financial tracking, and
            intelligence sharing. Analysts traced distinctive malware code and network
            infrastructure reused across multiple attacks, including the 2014 Sony Pictures
            hack, WannaCry ransomware outbreak, and large-scale cryptocurrency thefts. By
            mapping IP addresses, tracing crypto transactions through blockchain analysis,
            and linking these to behavioural patterns such as time zone activity and
            linguistic quirks, investigators built an attribution case strong enough for
            public indictment. This multi-source, cross-agency approach revealed not just
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-data-wrangling-and-exploration">
        ...
        <p>Exploratory analysis is like product discovery for your
            data. You don’t always know what you’re looking for, but if your tools are
        ...
        <p><strong><span style='font-family:"Inter",sans-serif'>Amplitude</span></strong>
            ...
            surfaced a 12% underreporting in key conversion steps and helped customers act
            on cleaner, truer funnel data.</p>

        <p align=center><img class="img-fluid rounded-corners mt-3"  width="431" height="287" id="Picture 1330787320"
                src="./images/productsanalyticsai/datascienceaiproductmanagers/image010.png"
                alt="A data-driven workspace where AI-assisted data wrangling is applied to customer event streams for improved internal funnel analysis. The scene highlights the discovery of misclassified sessions due to timestamp errors from mobile SDKs, with a 12% underreporting in key conversion steps prominently displayed. Visualize a team acting on cleaner, truer funnel data based on these findings.">
        </p>
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-testing-interventions">
        ...
        <p>Data-driven doesn’t mean reactive it means curious. When you
            treat product development like a series of small, smart experiments, you stop
...
<section data-subitem-id="productanalyticsai-data-science-ai-for-product-managers-case-study-generative-ai-irl">
        ...
        <p>Generative AI isn’t just a new tool;
            ...
            capability with real user goals, you don’t just make your product smarter, you
            make it feel more alive</p>

        <p align=center><b>Figma
                with FigJam AI (Beta)</b></p>

        <p><b>Use Case:</b> Collaborative
            interface design and whiteboarding.<br>
            <b>How they applied generative AI:</b>
        </p>
...
line-height:normal'><b>Canva Magic Studio (Magic Write, Magic Design)</b></p>
        ...
        <p>Data Science &amp; AI for Product
            ...
            that’s personalising onboarding, spotting anomalies before they turn into
            problems, or matching AI features to specific Jobs-to-be-Done. The conclusion
            is that the real competitive edge comes from aligning AI tools with user
...
<section data-conclusion-id="group-productanalyticsai-conclusion">
        ...
        <h2 id="group-productanalyticsai-conclusion"  align="center">Product Analytics and AI – Conclusion</h2>
            ...
            products are born at the intersection of deep customer understanding,
            evidence-based validation, seamless usability, and intelligent use of data and
            AI. Each of these disciplines, Consumer Analytics, Demand and Value Analytics,
            Usability Analytics, and Data Science plays a critical role, but together they
            form a single, powerful framework for building products that succeed in the
            real world.</p>
            
            <p>We start with <b>Customer
            Analytics</b> to uncover who our users are, what jobs they’re trying to get
            done, and where their experiences can be improved. This is more than collecting
            data, it is about transforming it into actionable insights that shape every
            decision from early concept to post-launch refinement.</p>
            
            <p>Next, <b>Demand and Value
            Analytics</b> ensures that we’re not just building for a user need, but for a
            solution that people actually want and will invest in. Through lean experiments
            like landing page tests, pre-orders, and fake features, we validate our
            riskiest assumptions early, using AI-driven sentiment analysis and predictive
            models to focus our energy where demand is strongest.</p>
            
            <p>From there, <b>Usability
            Analytics</b> keeps our focus on delivering experiences that are not only
            functional but intuitive and satisfying. We embed tracking from the earliest
            design stages, align it with user stories, and combine quantitative behaviour
            data with qualitative feedback to detect friction before it becomes a barrier.
            This approach allows us to be proactive whilst solving problems before they
            impact adoption or retention.</p>
            
            <p>Finally, <b>Data Science and AI</b>
            supercharge every stage of the process. Predictive models help us forecast user
            behaviour and spot issues before they escalate, while generative AI accelerates
            ideation, prototyping, and personalisation. When these capabilities are woven
            into product workflows, they help teams move faster, learn more, and make
            higher-quality decisions backed by real evidence.</p>
            
            <p>This unified approach turns
            product development into a continuous cycle of learning and improvement:
            understand the customer, confirm demand, ensure usability, and enhance every
            step with AI-driven insights. By integrating these practices, DeftAgile delivers
            products that not only meet market needs but also create lasting value and
            loyalty products that are as intelligent as they are impactful.</p>
    ...
    groups: [
        ...
        },
        {
            ...
            subItems: [
                { id: 'productanalyticsai-consumer-analytics-customer-introduction', text: 'Introduction to Customer Analytics' },
                { id: 'productanalyticsai-consumer-analytics-hypothesis-driven-development-revisited', text: 'Hypothesis-Driven Development Revisited' },
                { id: 'productanalyticsai-consumer-analytics-examples-of-hypothesis-metrics', text: 'Examples of Hypothesis Metrics' },
                { id: 'productanalyticsai-consumer-analytics-iteration-with-purpose', text: 'Iteration with Purpose' },
                { id: 'productanalyticsai-consumer-analytics-mapping-discovery-phase-product-hdd', text: 'The Mapping Discovery Phase of a Product to HDD & The Double Diamond Design Thinking Model' },
                { id: 'productanalyticsai-consumer-analytics-reclaiming-science-in-product-thinking', text: 'Reclaiming Science in Product Thinking' },
                { id: 'productanalyticsai-consumer-analytics-direct-customer-insight', text: 'Direct Customer Insight' },
                { id: 'productanalyticsai-consumer-analytics-making-journeys-testable', text: 'Making Journeys Testable' },
                { id: 'productanalyticsai-consumer-analytics-user-journey-focus', text: 'User Journey Focus' },
                { id: 'productanalyticsai-consumer-analytics-build-your-analytics-portfolio', text: 'Build Your Analytics Portfolio' },
                { id: 'productanalyticsai-consumer-analytics-from-data-to-action', text: 'From Data to Action' },
                { id: 'productanalyticsai-consumer-analytics-retrospective-testing', text: 'Retrospective Testing' },
                { id: 'productanalyticsai-consumer-analytics-prospective-testing', text: 'Prospective Testing' },
                { id: 'productanalyticsai-consumer-analytics-stats-for-decisions', text: 'Stats for Decisions' },
                { id: 'productanalyticsai-consumer-analytics-separating-laggards-vs-innovators', text: 'Separating Laggards vs. Innovators' }
            ]
        },
        {
            id: 'group-productanalyticsai-demand-value-analytics',
            groupTitle: 'Demand & Value Analytics',
            subItems: [
                { id: 'productanalyticsai-demand-value-analytics-demand-value-hypothesis', text: 'Demand & Value Hypothesis (Would they like our solutions to solve their problem?)' },
                { id: 'productanalyticsai-demand-value-analytics-lean-start-up-demand-hypothesis', text: 'Lean Start-up Demand Hypothesis' },
                { id: 'productanalyticsai-demand-value-analytics-demand-testing-strategies', text: 'Demand Testing Strategies' },
                { id: 'productanalyticsai-demand-value-analytics-designing-experiments', text: 'Designing Experiments' },
                { id: 'productanalyticsai-demand-value-analytics-mvp-experiments', text: 'MVP Experiments' },
                { id: 'productanalyticsai-demand-value-analytics-the-hook-framework', text: 'The Hook Framework' },
                { id: 'productanalyticsai-demand-value-analytics-6-experiment-charters', text: '6 Experiment Charters' },
                { id: 'productanalyticsai-demand-value-analytics-running-the-experiment', text: 'Running the Experiment' },
                { id: 'productanalyticsai-demand-value-analytics-testing-funnels', text: 'Testing Funnels' },
                { id: 'productanalyticsai-demand-value-analytics-testing-cohorts', text: 'Testing Cohorts' },
                { id: 'productanalyticsai-demand-value-analytics-part-1-experiment-design', text: 'Part 1 – Experiment Design: Testing a New Electronic Product for Designers & Managers' },
                { id: 'productanalyticsai-demand-value-analytics-part-2-experiment-execution', text: 'Part 2 – Experiment Execution: Testing a New Electronic Product for Designers & Managers' },
                { id: 'productanalyticsai-demand-value-analytics-ai-enhanced-experiment-lifecycle-testing', text: 'AI-Enhanced Experiment Lifecycle – Testing a New Electronic Product for Designers & Managers' },
                { id: 'productanalyticsai-demand-value-analytics-the-lifecycle-at-a-glance', text: 'The Lifecycle at a Glance' },
                { id: 'productanalyticsai-demand-value-analytics-diverging-your-ideas-with-generative-ai', text: 'Diverging Your Ideas with Generative AI' }
            ]
        },
        {
            id: 'group-productanalyticsai-usability-analytics',
            groupTitle: 'Usability Analytics',
            subItems: [
                { id: 'productanalyticsai-usability-analytics-usability-hypothesis', text: 'Usability Hypothesis (Is Our Interface Easy to Use?)' },
                { id: 'productanalyticsai-usability-analytics-tracking-key-outcomes', text: 'Tracking Key Outcomes' },
                { id: 'productanalyticsai-usability-analytics-google-analytics-for-usability', text: 'Google Analytics for Usability' },
                { id: 'productanalyticsai-usability-analytics-design-to-code-tracking', text: 'Design to Code Tracking' },
                { id: 'productanalyticsai-usability-analytics-code-to-analytics-loop', text: 'Code to Analytics Loop' },
                { id: 'productanalyticsai-usability-analytics-ab-testing', text: 'A/B Testing' },
                { id: 'productanalyticsai-usability-analytics-mapping-for-insights', text: 'Mapping for Insights' },
                { id: 'productanalyticsai-usability-analytics-user-stories-analytics-e-commerce', text: 'User Stories & Analytics (E-commerce)' },
                { id: 'productanalyticsai-usability-analytics-user-stories-analytics-saas', text: 'User Stories & Analytics (SaaS)' },
                { id: 'productanalyticsai-usability-analytics-cross-functional-collaboration', text: 'From Insights to Priorities' },
                { id: 'productanalyticsai-usability-analytics-learning-from-competitors-with-generative-ai', text: 'Learning from Competitors with Generative AI' },
                { id: 'productanalyticsai-usability-analytics-analytics-on-analytics', text: 'Analytics On Analytics' },
                { id: 'productanalyticsai-usability-analytics-qualitative-usability-testing', text: 'Qualitative Usability Testing' },
                { id: 'productanalyticsai-usability-analytics-existing-data-insights', text: 'Existing Data Insights' },
                { id: 'productanalyticsai-usability-analytics-field-insights', text: 'Field Insights' }
            ]
        },
        {
            id: 'group-productanalyticsai-data-science-ai-for-product-managers',
            groupTitle: 'Data Science and AI For Product Managers',
            subItems: [
                { id: 'productanalyticsai-data-science-ai-for-product-managers-data-science-basics', text: 'Data Science Basics' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-data-science-and-generative-ai', text: 'Data Science and Generative AI' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-predictive-ai-vs-generative-ai', text: 'Predictive AI vs.Generative AI' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-jtbd-and-ai-portfolio', text: 'JTBD and AI Portfolio' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-finding-ground-truth-with-ai', text: 'Finding Ground Truth with AI' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-easy-to-durable-wins-with-ai', text: 'Easy to Durable Wins with AI' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-working-with-data-science-teams', text: 'Working with Data Science Teams' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-the-hidden-dragon-case', text: 'The Hidden Dragon Case' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-data-wrangling-and-exploration', text: 'Data Wrangling and Exploration' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-testing-interventions', text: 'Testing & Interventions' },
                { id: 'productanalyticsai-data-science-ai-for-product-managers-case-study-generative-ai-irl', text: 'Case Study: Generative AI IRL(Figma with FigJam AI(Beta)' }
            ]
        },
        {
            id: 'group-productanalyticsai-conclusion',
